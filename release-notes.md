...
- Added [paragraph about intended AI usage](https://jqwik.net/docs/1.10.1/user-guide.html#anti-ai-usage-clause) to user guide:
...
<a href="/docs/1.9.2/javadoc/index.html">javadoc</a>
and <a href="/docs/1.9.2/kdoc/index.html">kdoc</a>
</p>
...
- [Default configuration](/docs/snapshot/user-guide.html#jqwik-configuration)
