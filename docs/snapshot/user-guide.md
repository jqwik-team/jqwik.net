---
title: jqwik User Guide - 1.10.0-SNAPSHOT
---
<h1>The jqwik User Guide
<span style="padding-left:1em;font-size:50%;font-weight:lighter">1.10.0-SNAPSHOT</span>
</h1>
...
ext.jqwikVersion = '1.10.0-SNAPSHOT'
...
- `jqwik-api-1.10.0-SNAPSHOT.jar`
- `jqwik-engine-1.10.0-SNAPSHOT.jar`
...
[`@ForAll`](/docs/1.10.0-SNAPSHOT/javadoc/net/jqwik/api/ForAll.html).
...
[Here](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/PropertyBasedTests.java)
...
[Here](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/ExampleBasedTests.java)
...
[In the following example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/NamingExamples.java),
...
Have a look at
[the following example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/TaggingExamples.java).
...
Consider
[the following examples](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/VariableTypedPropertyExamples.java):
...
Look at the
[following example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/ProvideMethodExamples.java):
...
[the given example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/ChoosingExamples.java#L17)
...
Here are a
[two examples](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/FluentConfigurationExamples.java)
...
use
[`Arbitrary.filter(Predicate<? super T> filterPredicate)`](/docs/snapshot/javadoc/net/jqwik/api/Arbitrary.html#filter(java.util.function.Predicate)).
...
Have a look at the
[following example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L26):
...
- `begin` must not be larger than `end`
  ...
  [like this](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L32):
...
[In this example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/OneOfExamples.java)
...
[The following example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/MappingAndCombinatorExamples.java#L25)
...
Look at the
[following example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/RecursiveExamples.java)
...
[simple stack implementation](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/state/mystack/MyStringStack.java):
...
To make this abstract concept concrete, let's look at a
[simple stack implementation](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStack.java):
...
- [`Push`](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PushAction.java):
...
- [`Pop`](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PopAction.java):
  If (and only if) the stack is not empty, pop the element on top off the stack.
  The size of the stack should have decreased by 1.
...
- [`Clear`](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/stateful/mystack/ClearAction.java):
...
[_jqwik_ property](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStackProperties.java):
...
[The following property](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/AssumptionExamples.java)
...
[Here](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/statistics/StatisticsExamples.java)
...
There is a
[`@StatisticsReport`](/docs/snapshot/javadoc/net/jqwik/api/statistics/StatisticsReport.html)
...
[StatisticsReportMode.OFF](/docs/snapshot/javadoc/net/jqwik/api/statistics/StatisticsReport.StatisticsReportMode.html) and can have one of:
...
[`Histogram`](/docs/snapshot/javadoc/net/jqwik/api/statistics/Histogram.html)
and [`NumberRangeHistogram`](/docs/snapshot/javadoc/net/jqwik/api/statistics/NumberRangeHistogram.html).
...
[StatisticsReportFormat](/docs/snapshot/javadoc/net/jqwik/api/statistics/StatisticsReportFormat.html) and
...
Consider the class [`Money`](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/defaultprovider/Money.java):
...
[`MoneyArbitraryProvider`](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyArbitraryProvider.java):
...
in file
[`META-INF/services/net.jqwik.api.providers.ArbitraryProvider`](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/resources/META-INF/services/net.jqwik.api.providers.ArbitraryProvider)
with such an entry:
...
The
[following property](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyProperties.java)
...
the [following example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/OddProperties.java)
will work:
...
[in one place](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/domains/AmericanAddresses.java):
...
at the [complete example](https://github.com/jqwik-team/jqwik/blob/master/documentation/src/test/java/net/jqwik/docs/types/TypeArbitraryExamples.java)
and check the following api entry points:

- [UseType](/docs/snapshot/javadoc/net/jqwik/api/constraints/UseType.html)
- [UseTypeMode](/docs/snapshot/javadoc/net/jqwik/api/constraints/UseTypeMode.html)
...
- or use the [`@Email`](/docs/snapshot/javadoc/net/jqwik/web/api/Email.html)
...
- [`LocalDateArbitrary dates()`](/docs/snapshot/javadoc/net/jqwik/time/api/Dates.html#dates())
- [`CalendarArbitrary datesAsCalendar()`](/docs/snapshot/javadoc/net/jqwik/time/api/Dates.html#datesAsCalendar())
- [`DateArbitrary datesAsDate()`](/docs/snapshot/javadoc/net/jqwik/time/api/Dates.html#datesAsDate())
- [`YearArbitrary years()`](/docs/snapshot/javadoc/net/jqwik/time/api/Dates.html#years())
- [`Arbitrary<Month> months()`](/docs/snapshot/javadoc/net/jqwik/time/api/Dates.html#months())
- [`Arbitrary<Integer> daysOfMonth()`](/docs/snapshot/javadoc/net/jqwik/time/api/Dates.html#daysOfMonth())
- [`Arbitrary<DayOfWeek> daysOfWeek()`](/docs/snapshot/javadoc/net/jqwik/time/api/Dates.html#daysOfWeek())
- [`YearMonthArbitrary yearMonths()`](/docs/snapshot/javadoc/net/jqwik/time/api/Dates.html#yearMonths())
...
dependencies {
    ...
    testImplementation("net.jqwik:jqwik-kotlin:1.10.0-SNAPSHOT")
}
...
Read this version's [release notes](/release-notes.html#1100-snapshot).
