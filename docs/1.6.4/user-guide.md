...
[Here](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/PropertyBasedTests.java)
...
[Here](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/ExampleBasedTests.java)
...
Have a look at [this example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/TestsWithGroups.java):
...
[In the following example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/NamingExamples.java),
...
Have a look at
[the following example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/TaggingExamples.java).
...
- [`@NotBlank`](/docs/1.6.4/javadoc/net/jqwik/api/constraints/NotBlank.html):
...
Consider
[the following examples](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/VariableTypedPropertyExamples.java):
...
Look at the
[following example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/ProvideMethodExamples.java):
...
[the given example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/ChoosingExamples.java#L17)
...
Here are a
[two examples](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/FluentConfigurationExamples.java)
...
Have a look at the
[following example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L26):
...
- `begin` must not be larger than `end`
  ...
  [like this](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L32):
...
[In this example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/OneOfExamples.java)
...
[The following example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/MappingAndCombinatorExamples.java#L25)
...
Look at the
[following example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/RecursiveExamples.java)
...
- It is important to use 
  [`lazyOf(suppliers)`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitraries.html#lazyOf(java.util.function.Supplier,java.util.function.Supplier...))
  instead of the seemingly simpler 
  [`oneOf(arbitraries)`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitraries.html#oneOf(net.jqwik.api.Arbitrary,net.jqwik.api.Arbitrary...)).
...
- [`Arbitraries.recursive(..., depth)`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitraries.html#recursive(java.util.function.Supplier,java.util.function.Function,int)).
- [`Arbitraries.recursive(..., minDepth, maxDepth)`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitraries.html#recursive(java.util.function.Supplier,java.util.function.Function,int,int)).
...
with [`Arbitrary.sample()`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitrary.html#sample()):
...
Getting a stream of generated values is just as easy with [`Arbitrary.sampleStream()`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitrary.html#sampleStream()):
...
[`Arbitrary.allValues()`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitrary.html#allValues()).
...
Use
[`Arbitrary.forEachValue(Consumer action)`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitrary.html#forEachValue(java.util.function.Consumer)).
...
[simple stack implementation](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStack.java):
...
- [`Push`](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PushAction.java):
...
- [`Pop`](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PopAction.java):
...
- [`Clear`](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/stateful/mystack/ClearAction.java):
...
[_jqwik_ property](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStackProperties.java):
...
- [`ActionSequence`](/docs/1.6.4/javadoc/net/jqwik/api/stateful/ActionSequence.html):
...
- [`Arbitraries.sequences()`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitraries.html#sequences(net.jqwik.api.Arbitrary)):
...
[The following property](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/AssumptionExamples.java)
...
[`Assume.that(boolean condition)`](/docs/1.6.4/javadoc/net/jqwik/api/Assume.html#that(boolean))
...
[`@Property`](/docs/1.6.4/javadoc/net/jqwik/api/Property.html) annotation.
...
[`Assume.that()`](/docs/1.6.4/javadoc/net/jqwik/api/Assume.html#that(boolean))
...
[`Statistics.collect()`](/docs/1.6.4/javadoc/net/jqwik/api/statistics/Statistics.html#collect(java.lang.Object...))
...
[Here](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/statistics/StatisticsExamples.java)
...
There is a
[`@StatisticsReport`](/docs/1.6.4/javadoc/net/jqwik/api/statistics/StatisticsReport.html)
...
[StatisticsReportMode.OFF](/docs/1.6.4/javadoc/net/jqwik/api/statistics/StatisticsReport.StatisticsReportMode.html) and can have one of:
...
[`Histogram`](/docs/1.6.4/javadoc/net/jqwik/api/statistics/Histogram.html)
and [`NumberRangeHistogram`](/docs/1.6.4/javadoc/net/jqwik/api/statistics/NumberRangeHistogram.html).
...
[StatisticsReportFormat](/docs/1.6.4/javadoc/net/jqwik/api/statistics/StatisticsReportFormat.html) and
...
Start by looking at
[`Statistics.coverage()`](/docs/1.6.4/javadoc/net/jqwik/api/statistics/Statistics.html#coverage(java.util.function.Consumer))
...
- Implement the interface [`ArbitraryProvider`](/docs/1.6.4/javadoc/net/jqwik/api/providers/ArbitraryProvider.html).<br/>
...
with [`@ForAll`](/docs/1.6.4/javadoc/net/jqwik/api/ForAll.html) that has no explicit `value`.
...
Consider the class [`Money`](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/defaultprovider/Money.java):
...
[`MoneyArbitraryProvider`](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyArbitraryProvider.java):
...
in file
[`META-INF/services/net.jqwik.api.providers.ArbitraryProvider`](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/resources/META-INF/services/net.jqwik.api.providers.ArbitraryProvider)
with such an entry:
...
The
[following property](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyProperties.java)
...
1. Create an implementation of an interface, in this case
   [`ArbitraryConfigurator`](/docs/1.6.4/javadoc/net/jqwik/api/configurators/ArbitraryConfigurator.html).
...
the [`@Odd` annotation](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/Odd.java)
together with the
[configurator implementation](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/OddConfigurator.java):
...
If you now
[register the implementation](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/resources/META-INF/services/net.jqwik.api.configurators.ArbitraryConfigurator),
the [following example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/OddProperties.java)
will work:
...
[DomainContext](/docs/1.6.4/javadoc/net/jqwik/api/domains/DomainContext.html)
and [DomainContextBase](/docs/1.6.4/javadoc/net/jqwik/api/domains/DomainContextBase.html).
...
[in one place](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/domains/AmericanAddresses.java):
...
at the [complete example](https://github.com/jqwik-team/jqwik/blob/1.6.4/documentation/src/test/java/net/jqwik/docs/types/TypeArbitraryExamples.java)
and check the following api entry points:

- [UseType](/docs/1.6.4/javadoc/net/jqwik/api/constraints/UseType.html)
- [UseTypeMode](/docs/1.6.4/javadoc/net/jqwik/api/constraints/UseTypeMode.html)
- [Arbitraries.forType()](/docs/1.6.4/javadoc/net/jqwik/api/Arbitraries.html#forType(java.lang.Class))
- [TypeArbitrary](/docs/1.6.4/javadoc/net/jqwik/api/arbitraries/TypeArbitrary.html)
...
This is done through [`Arbitrary.edgeCases(config)`](/docs/1.6.4/javadoc/net/jqwik/api/Arbitrary.html#edgeCases(java.util.function.Consumer)). 
...
The [`Table` class](/docs/1.6.4/javadoc/net/jqwik/api/Table.html)
...
- call up the static method [`Web.emails()`](/docs/1.6.4/javadoc/net/jqwik/web/api/Web.html#emails()).
  The return type is [`EmailArbitrary`](/docs/1.6.4/javadoc/net/jqwik/web/api/EmailArbitrary.html)
  which provides a few configuration methods.

- or use the [`@Email`](/docs/1.6.4/javadoc/net/jqwik/web/api/Email.html)
...
- call up the static method [`Web.webDomains()`](/docs/1.6.4/javadoc/net/jqwik/web/api/Web.html#webDomains())

- or use the annotation [`@WebDomain`](/docs/1.6.4/javadoc/net/jqwik/web/api/WebDomain.html)
...
- [`@DateRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/DateRange.html)
- [`@YearRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/YearRange.html)
- [`@YearMonthRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/YearMonthRange.html)
- [`@MonthRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/MonthRange.html)
- [`@MonthDayRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/MonthDayRange.html)
- [`@DayOfMonthRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/DayOfMonthRange.html)
- [`@DayOfWeekRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/DayOfWeekRange.html)
- [`@PeriodRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/PeriodRange.html)
...
method call on class [`Dates`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html).
For example:
...
- [`LocalDateArbitrary dates()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#dates())
- [`CalendarArbitrary datesAsCalendar()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#datesAsCalendar())
- [`DateArbitrary datesAsDate()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#datesAsDate())
- [`YearArbitrary years()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#years())
- [`Arbitrary<Month> months()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#months())
- [`Arbitrary<Integer> daysOfMonth()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#daysOfMonth())
- [`Arbitrary<DayOfWeek> daysOfWeek()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#daysOfWeek())
- [`YearMonthArbitrary yearMonths()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#yearMonths())
- [`MonthDayArbitrary monthDays()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#monthDays())
- [`PeriodArbitrary periods()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Dates.html#periods())
...
- [`@TimeRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/TimeRange.html)
- [`@OffsetRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/OffsetRange.html)
- [`@HourRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/HourRange.html)
- [`@MinuteRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/MinuteRange.html)
- [`@SecondRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/SecondRange.html)
- [`@Precision`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/Precision.html)
- [`@DurationRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/DurationRange.html)
...
method call on class [`Times`](/docs/1.6.4/javadoc/net/jqwik/time/api/Times.html).
For example:
...
- [`LocalTimeArbitrary times()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Times.html#times())
- [`OffsetTimeArbitrary offsetTimes()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Times.html#offsetTimes())
- [`ZoneOffsetArbitrary zoneOffsets()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Times.html#zoneOffsets())
- [`Arbitrary<TimeZone> timeZones()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Times.html#timeZones())
- [`Arbitrary<ZoneId> zoneIds()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Times.html#zoneIds())
- [`DurationArbitrary durations()`](/docs/1.6.4/javadoc/net/jqwik/time/api/Times.html#durations())
...
- [`@DateTimeRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/DateTimeRange.html)
- [`@InstantRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/InstantRange.html)
- [`@DateRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/DateRange.html)
- [`@YearRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/YearRange.html)
- [`@MonthRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/MonthRange.html)
- [`@DayOfMonthRange`](/docs/1.6.4/javadoc/net/jqwik/time/api/constraints/DayOfMonthRange.html)
...
method call on class [`DateTimes`](/docs/1.6.4/javadoc/net/jqwik/time/api/DateTimes.html).
For example:
...
- [`LocalDateTimeArbitrary dateTimes()`](/docs/1.6.4/javadoc/net/jqwik/time/api/DateTimes.html#dateTimes())
- [`InstantArbitrary instants()`](/docs/1.6.4/javadoc/net/jqwik/time/api/DateTimes.html#instants())
- [`OffsetDateTimeArbitrary offsetDateTimes()`](/docs/1.6.4/javadoc/net/jqwik/time/api/DateTimes.html#offsetDateTimes())
- [`ZonedDateTimeArbitrary zonedDateTimes()`](/docs/1.6.4/javadoc/net/jqwik/time/api/DateTimes.html#zonedDateTimes())
...
1. There are several [types of lifecycle hooks](#lifecycle-hook-types),
   ...
   [`net.jqwik.api.lifecycle.LifecycleHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/LifecycleHook.html).
...
3. You can add a concrete lifecycle hook to a container class or a property method with the annotation
   [`@AddLifecycleHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/AddLifecycleHook.html).
...
7. If relevant, the order in which hook methods are being applied is determined by dedicated methods
   ...
   [`BeforeContainerHook.beforeContainerProximity()`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/BeforeContainerHook.html#beforeContainerProximity()).
...
- [`propagateTo()`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/LifecycleHook.html#propagateTo()):
  Determine if and how a hook will be propagated to an element's children.

- [`appliesTo(Optional<AnnotatedElement>)`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/LifecycleHook.html#appliesTo(java.util.Optional)):
...
Implement [`SkipExecutionHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/SkipExecutionHook.html)
...
Implement [`BeforeContainerHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/BeforeContainerHook.html)
...
Implement [`AfterContainerHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/AfterContainerHook.html)
...
[`AroundContainerHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/AroundContainerHook.html)
...
[`AroundPropertyHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/AroundPropertyHook.html)
...
and publish the result using a [`Reporter`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/Reporter.html):
...
[`AroundTryHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/AroundTryHook.html).
...
[`ResolveParameterHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/ResolveParameterHook.html).
...
Use [`RegistrarHook`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/RegistrarHook.html)
...
[`net.jqwik.api.lifecycle.Store`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/Store.html).
...
- has a [`Lifespan`](/docs/1.6.4/javadoc/net/jqwik/api/lifecycle/Lifespan.html).
...
its [Javadoc](/docs/1.6.4/javadoc) but also through reflection.
...
Read this version's [release notes](/release-notes.html#164).
