---
title: jqwik User Guide - 1.2.1
---
<h1>The jqwik User Guide
<span style="padding-left:1em;font-size:50%;font-weight:lighter">1.2.1</span>
</h1>
...
[`@Example`](/docs/1.2.1/javadoc/net/jqwik/api/Example.html).
...
[Here](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/ExampleBasedTests.java)
...
[Here](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/PropertyBasedTests.java)
...
The [`@Property`](/docs/1.2.1/javadoc/net/jqwik/api/Property.html) 
...
[`@Report(Reporting[])` annotation](/docs/1.2.1/javadoc/net/jqwik/api/Property.html)
...
- For each method, annotated with 
  [`@Property`](/docs/1.2.1/javadoc/net/jqwik/api/Property.html) 
  or [`@Example`](/docs/1.2.1/javadoc/net/jqwik/api/Example.html), 
...
[In this example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/TestsWithLifecycle.java)
...
Have a look at [this example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/TestsWithGroups.java):
...
[In the following example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/NamingExamples.java),
...
Have a look at 
[the following example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/TaggingExamples.java).
...
annotated with [`@ForAll`](/docs/1.2.1/javadoc/net/jqwik/api/ForAll.html). If the annotation does not have a `value` parameter,
...
If you use [`@ForAll`](/docs/1.2.1/javadoc/net/jqwik/api/ForAll.html) 
...
- [`@WithNull(double value = 0.1)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/WithNull.html): 
...
- [`@Unique`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/Unique.html):
...
- [`@StringLength(int value = 0, int min = 0, int max = 0)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/StringLength.html):
  Set either fixed length through `value` or configure the length range between `min` and `max`.

- [`@NotEmpty`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/NotEmpty.html):
...
- [`@Chars(chars[] value = {})`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/Chars.html):
  Specify a set of characters.
  This annotation can be repeated which will add up all allowed chars.
- [`@CharRange(char from = 0, char to = 0)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/CharRange.html):
  Specify a start and end character.
  This annotation can be repeated which will add up all allowed chars.
- [`@NumericChars`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/NumericChars.html):
  Use digits `0` through `9`
- [`@LowerChars`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/LowerChars.html):
  Use lower case chars `a` through `z`
- [`@UpperChars`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/UpperChars.html):
  Use upper case chars `A` through `Z`
- [`@AlphaChars`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/AlphaChars.html):
  Lower and upper case chars are allowed.
- [`@Whitespace`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/Whitespace.html):
...
- [`@Size(int value = 0, int min = 0, int max = 0)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/Size.html): 
...
- [`@ByteRange(byte min = 0, byte max = Byte.MAX_VALUE)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/ByteRange.html):
  For `Byte` and `byte` only.
- [`@ShortRange(short min = 0, short max = Short.MAX_VALUE)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/ShortRange.html):
  For `Short` and `short` only.
- [`@IntRange(int min = 0, int max = Integer.MAX_VALUE)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/IntRange.html):
  For `Integer` and `int` only.
- [`@LongRange(long min = 0L, long max = Long.MAX_VALUE)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/LongRange.html):
  For `Long` and `long` only.
- [`@BigRange(String min = "", String max = "")`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/BigRange.html):
  For `BigInteger` generation.
- [`@Positive`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/Positive.html):
  Numbers larger than `0`. For all integral types.
- [`@Negative`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/Negative.html):
  Numbers lower than `0`. For all integral types.


#### Decimal Constraints

- [`@FloatRange(float min = 0.0f, float max = Float.MAX_VALUE)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/FloatRange.html):
  For `Float` and `float` only.
- [`@DoubleRange(double min = 0.0, double max = Double.MAX_VALUE)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/DoubleRange.html):
  For `Double` and `double` only.
- [`@BigRange(String min = "", String max = "")`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/BigRange.html):
  For `BigDecimal` generation.
- [`@Scale(int value)`](/docs/1.2.1/javadoc/net/jqwik/api/constraints/Scale.html):
...
Consider
[the following examples](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/VariableTypedPropertyExamples.java):
...
instead of using _jqwik_'s built-in ones. BTW, '@Example' is nothing but a plain annotation using [`@Property`](/docs/1.2.1/javadoc/net/jqwik/api/Property.html)
as "meta"-annotation.
...
Look at the 
[following example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/ProvideMethodExamples.java):
...
The String value of the [`@ForAll`](/docs/1.2.1/javadoc/net/jqwik/api/ForAll.html) 
...
[`@Arbitrary<T>`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html) 
...
[`Arbitraries`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html). 

#### Generate values yourself

- [`Arbitrary<T> randomValue(Function<Random, T> generator)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#randomValue-java.util.function.Function-): 
...
- [`Arbitrary<T> fromGenerator(RandomGenerator<T> generator)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#fromGenerator-net.jqwik.api.RandomGenerator-):
...
- [`Arbitrary<U> of(U... values)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#of-U...-):
  Choose randomly from a list of values. Shrink towards the first one.
  
- [`Arbitrary<T> samples(T... samples)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#samples-T...-):
  ...
  [`Arbitrary.withSamples(T... samples)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#withSamples-T...-).
...
- [`Arbitrary<T> of(Class<T  extends Enum> enumClass)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#of-java.lang.Class-):
...
[`Arbitraries.frequency(...)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#frequency-net.jqwik.api.Tuple.Tuple2...-):
...
[the given example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/ChoosingExamples.java#L17)
...
- [`ByteArbitrary bytes()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#bytes--)
- [`ShortArbitrary shorts()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#shorts--)
- [`IntegerArbitrary integers()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#integers--)
- [`LongArbitrary longs()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#longs--)
- [`BigIntegerArbitrary bigIntegers()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#bigIntegers--)

#### Decimals

- [`FloatArbitrary floats()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#floats--)
- [`DoubleArbitrary doubles()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#doubles--)
- [`BigDecimalArbitrary bigDecimals()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#bigDecimals--)

#### Characters and Strings

- [`StringArbitrary strings()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#strings--)
- [`CharacterArbitrary chars()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#chars--)

#### java.util.Random

- [`Arbitrary<Random> randoms()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#randoms--): 
  Random instances will never be shrunk

#### Constants

- [`Arbitrary<T> constant(T value)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#constant-T-): 
  In each try use the same unshrinkable `value` of type `T`.

#### Create

- [`Arbitrary<T> create(Supplier<T> supplier)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#constant-java.util.function.Supplier-): 
  In each try use a new unshrinkable instance of type `T` using `supplier` to freshly create it.

#### Shuffling Permutations

- [`Arbitrary<List<T>> shuffle(T ... values)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#shuffle-T...-):
  Return unshrinkable permutations of the `values` handed in.

- [`Arbitrary<List<T>> shuffle(List<T> values)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#shuffle-java.util.List-):
  Return unshrinkable permutations of the `values` handed in.

#### Default Types

- [`Arbitrary<T> defaultFor(Class<T> type, Class<?> ... parameterTypes)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#defaultFor-java.lang.Class-java.lang.Class...-): 
  ...
  cannot be used in the respective [`@ForAll`](/docs/1.2.1/javadoc/net/jqwik/api/ForAll.html) property method parameter. Raw types and wildcards, 
...
- [`Arbitrary.list()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#list--)
- [`Arbitrary.set()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#set--)
- [`Arbitrary.streamOf()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#stream--)
- [`Arbitrary.array(Class<A> arrayClass)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#array-java.lang.Class-)
- [`Arbitrary.optional()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#optional--)
...
[`Arbitrary.collect(Predicate condition)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#collect-java.util.function.Predicate-)
...
[`Arbitraries.maps(...)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#maps-net.jqwik.api.Arbitrary-net.jqwik.api.Arbitrary-) like this:
...
[`Arbitraries.entries(...)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#maps-net.jqwik.api.Arbitrary-net.jqwik.api.Arbitrary-).
...
- [BigDecimalArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/BigDecimalArbitrary.html)
- [BigIntegerArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/BigIntegerArbitrary.html)
- [ByteArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/ByteArbitrary.html)
- [CharacterArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/CharacterArbitrary.html)
- [DoubleArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/DoubleArbitrary.html)
- [FloatArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/FloatArbitrary.html)
- [IntegerArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/IntegerArbitrary.html)
- [LongArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/LongArbitrary.html)
- [ShortArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/ShortArbitrary.html)
- [SizableArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/SizableArbitrary.html)
- [StreamableArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/StreamableArbitrary.html)
- [StringArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/StringArbitrary.html)
- [FunctionArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/FunctionArbitrary.html)


Here are a 
[two examples](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/FluentConfigurationExamples.java)
...
call [`Arbitrary.injectNull(double probability)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#injectNull-double-). 
...
use 
[`Arbitrary.filter(Predicate<T> filterPredicate)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#filter-java.util.function.Predicate-). 
...
use
[`Arbitrary.unique()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#unique--).
...
[`Arbitrary.map(Function<T, U> mapper)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#map-java.util.function.Function-).
...
Have a look at the 
[following example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L26):
...
[`flatMap`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#flatMap-java.util.function.Function-) 
combined with a tuple type 
[like this](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L32):
...
[In this example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/OneOfExamples.java)
...
[`Combinators.combine()`](/docs/1.2.1/javadoc/net/jqwik/api/Combinators.html#combine-net.jqwik.api.Arbitrary-net.jqwik.api.Arbitrary-) 
...
[The following example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/MappingAndCombinatorExamples.java#L25)
...
Have a look at 
[Combinators.withBuilder(Supplier)](/docs/1.2.1/javadoc/net/jqwik/api/Combinators.html#withBuilder-java.util.function.Supplier-)
and [Combinators.withBuilder(Arbitrary)](/docs/1.2.1/javadoc/net/jqwik/api/Combinators.html#withBuilder-net.jqwik.api.Arbitrary-)
to check the API.
...
[`Arbitrary.fixGenSize(int)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#fixGenSize-int-)..
...
[`Arbitrary.allValues()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#allValues--).
...
Use
[`Arbitrary.forEachValue(Consumer action)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitrary.html#forEachValue-java.util.function.Consumer-).
...
Look at the 
[following example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/RecursiveExamples.java)
...
- Use [`Arbitraries.lazy(Supplier<Arbitrary<T>>)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#lazy-java.util.function.Supplier-) 
...
[`Arbitraries.recursive(...)`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#recursive-java.util.function.Supplier-java.util.function.Function-int-).
...
[simple stack implementation](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStack.java):
...
- [`Push`](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PushAction.java):
...
- [`Pop`](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PopAction.java):
...
- [`Clear`](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/ClearAction.java):
...
[_jqwik_ property](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStackProperties.java):
...
- [`ActionSequence`](/docs/1.2.1/javadoc/net/jqwik/api/stateful/ActionSequence.html):
...
- [`Arbitraries.sequences()`](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#sequences-net.jqwik.api.Arbitrary-):
...
[The following property](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/AssumptionExamples.java)
...
[`Assume.that(boolean condition)`](/docs/1.2.1/javadoc/net/jqwik/api/Assume.html#that-boolean-) 
...
[`@Property`](/docs/1.2.1/javadoc/net/jqwik/api/Property.html) annotation.
...
[`Assume.that()`](/docs/1.2.1/javadoc/net/jqwik/api/Assume.html#that-boolean-)
...
Consider a somewhat 
[more complicated example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/ShrinkingExamples.java#L15):
...
[`Statistics.collect()`](/docs/1.2.1/javadoc/net/jqwik/api/Statistics.html#collect-java.lang.Object...-)
...
[Here](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/StatisticsExamples.java)
...
- Implement the interface [`ArbitraryProvider`](/docs/1.2.1/javadoc/net/jqwik/api/providers/ArbitraryProvider.html).<br/>
...
with [`@ForAll`](/docs/1.2.1/javadoc/net/jqwik/api/ForAll.html) that has no explicit `value`.
...
Consider the class [`Money`](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/defaultprovider/Money.java):
...
[`MoneyArbitraryProvider`](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyArbitraryProvider.java):
...
in file 
[`META-INF/services/net.jqwik.api.providers.ArbitraryProvider`](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/resources/META-INF/services/net.jqwik.api.providers.ArbitraryProvider)
with such an entry:
...
The 
[following property](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyProperties.java)
...
1. Create an implementation of an interface, in this case 
  [`ArbitraryConfigurator`](/docs/1.2.1/javadoc/net/jqwik/api/configurators/ArbitraryConfigurator.html).
...
the [`@Odd` annotation](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/Odd.java)
together with the 
[configurator implementation](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/OddConfigurator.java):
...
If you now 
[register the implementation](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/resources/META-INF/services/net.jqwik.api.configurators.ArbitraryConfigurator),
the [following example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/OddProperties.java)
will work:
...
[DomainContext](/docs/1.2.1/javadoc/net/jqwik/api/domains/DomainContext.html)
and [AbstractDomainContextBase](/docs/1.2.1/javadoc/net/jqwik/api/domains/AbstractDomainContextBase.html).
...
[AmericanAddresses](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/domains/AmericanAddresses.java).
Now look at
[this example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/domains/AddressProperties.java):
...
at the [complete example](https://github.com/jqwik-team/jqwik/blob/1.2.1/documentation/src/test/java/net/jqwik/docs/types/TypeArbitraryExamples.java)
and check the following api entry points:

- [UseType](/docs/1.2.1/javadoc/net/jqwik/api/constraints/UseType.html)
- [UseTypeMode](/docs/1.2.1/javadoc/net/jqwik/api/constraints/UseTypeMode.html)
- [Arbitraries.forType()](/docs/1.2.1/javadoc/net/jqwik/api/Arbitraries.html#forType-java.lang.Class-)
- [TypeArbitrary](/docs/1.2.1/javadoc/net/jqwik/api/arbitraries/TypeArbitrary.html)
...
- [DefaultBigDecimalArbitrary](https://github.com/jqwik-team/jqwik/blob/1.2.1/engine/src/main/java/net/jqwik/engine/properties/arbitraries/DefaultBigDecimalArbitrary.java)
- [DefaultStringArbitrary](https://github.com/jqwik-team/jqwik/blob/1.2.1/engine/src/main/java/net/jqwik/engine/properties/arbitraries/DefaultStringArbitrary.java)

Under the hood, most arbitraries use `RandomGenerator`s for the final value generation. Since
[`RandomGenerator`](/docs/1.2.1/javadoc/net/jqwik/api/RandomGenerator.html) 
is a SAM type, most implementations are just lambda expression. 
Start with the methods on
[`RandomGenerators`](https://github.com/jqwik-team/jqwik/blob/1.2.1/engine/src/main/java/net/jqwik/engine/properties/arbitraries/randomized/RandomGenerators.java)
...
The [`Table` class](/docs/1.2.1/javadoc/net/jqwik/api/Table.html) 
...
Read this version's [release notes](/release-notes.html#121).