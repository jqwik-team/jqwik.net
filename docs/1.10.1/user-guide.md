...
<span style="padding-left:1em;font-size:50%;font-weight:lighter">1.10.1</span>
</h1>
...
- [How to Use](#how-to-use)
  ...
  - [Anti-AI Usage Clause](#anti-ai-usage-clause)
- [Writing Properties](#writing-properties)
...
- `jqwik-api-1.10.1.jar`
- `jqwik-engine-1.10.1.jar`
- `junit-platform-engine-1.14.4.jar`
- `junit-platform-commons-1.14.4.jar`
- `opentest4j-1.3.0.jar`

Optional jars are:
- `jqwik-web-1.10.1.jar`
- `jqwik-time-1.10.1.jar`
...
[Here](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/PropertyBasedTests.java)
...
- register an implementation of [`net.jqwik.api.SampleReportingFormat`](/docs/1.10.1/javadoc/net/jqwik/api/SampleReportingFormat.html)
  through Java’s `java.util.ServiceLoader` mechanism.
- add an implementation of [`net.jqwik.api.SampleReportingFormat`](/docs/1.10.1/javadoc/net/jqwik/api/SampleReportingFormat.html)
...
[`@Report(Reporting[])` annotation](/docs/1.10.1/javadoc/net/jqwik/api/Property.html)
...
[net.jqwik.api.Reporter](/docs/1.10.1/javadoc/net/jqwik/api/Reporter.html)
...
The [`@Property`](/docs/1.10.1/javadoc/net/jqwik/api/Property.html)
...
[`@PropertyDefaults`](/docs/1.10.1/javadoc/net/jqwik/api/PropertyDefaults.html).
...
[`@Example`](/docs/1.10.1/javadoc/net/jqwik/api/Example.html).
...
[Here](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/ExampleBasedTests.java)
...
- __Properties__: Methods annotated with
  [`@Property`](/docs/1.10.1/javadoc/net/jqwik/api/Property.html) or
  [`@Example`](/docs/1.10.1/javadoc/net/jqwik/api/Example.html).
...
- [`@BeforeContainer`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/BeforeContainer.html):
...
- [`@AfterContainer`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/AfterContainer.html):
  _Static_ methods with this annotation will run exactly once after all properties
  of a container class have run.
- [`@BeforeProperty`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/BeforeProperty.html):
...
- [`@AfterProperty`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/AfterProperty.html):
...
- [`@BeforeTry`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/BeforeTry.html):
  Methods with this annotation will run once before each try, i.e. execution
  of a property or example method.
- [`@AfterTry`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/AfterTry.html):
...
Have a look at [`PerProperty.Lifecycle`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/PerProperty.Lifecycle.html)
...
Have a look at [this example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/TestsWithGroups.java):
...
[In the following example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/NamingExamples.java),
...
Have a look at
[the following example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/TaggingExamples.java).
...
[here](/docs/1.10.1/javadoc/net/jqwik/api/Tag.html).
...
[`@Disabled`](/docs/1.10.1/javadoc/net/jqwik/api/Disabled.html) annotation
...
annotated with [`@ForAll`](/docs/1.10.1/javadoc/net/jqwik/api/ForAll.html). If the annotation does not have a `value` parameter,
...
If you use [`@ForAll`](/docs/1.10.1/javadoc/net/jqwik/api/ForAll.html)
...
- [`@WithNull(double value = 0.1)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/WithNull.html):
...
- [`@StringLength(int value = 0, int min = 0, int max = 0)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/StringLength.html):
  Set either fixed length through `value` or configure the length range between `min` and `max`.

- [`@NotEmpty`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/NotEmpty.html):
  Set minimum length to `1`.

#### String not Blank

- [`@NotBlank`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/NotBlank.html):
...
- [`@Chars(chars[] value = {})`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/Chars.html):
  Specify a set of characters.
  This annotation can be repeated which will add up all allowed chars.
- [`@CharRange(char from = 0, char to = 0)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/CharRange.html):
  Specify a start and end character.
  This annotation can be repeated which will add up all allowed chars.
- [`@NumericChars`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/NumericChars.html):
  Use digits `0` through `9`
- [`@LowerChars`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/LowerChars.html):
  Use lower case chars `a` through `z`
- [`@UpperChars`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/UpperChars.html):
  Use upper case chars `A` through `Z`
- [`@AlphaChars`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/AlphaChars.html):
  Lower and upper case chars are allowed.
- [`@Whitespace`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/Whitespace.html):
...
- [`@Size(int value = 0, int min = 0, int max = 0)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/Size.html):
...
- [`@UniqueElements`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/UniqueElements.html):
...
- [`@ByteRange(byte min = 0, byte max = Byte.MAX_VALUE)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/ByteRange.html):
  For `Byte` and `byte` only.
- [`@ShortRange(short min = 0, short max = Short.MAX_VALUE)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/ShortRange.html):
  For `Short` and `short` only.
- [`@IntRange(int min = 0, int max = Integer.MAX_VALUE)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/IntRange.html):
  For `Integer` and `int` only.
- [`@LongRange(long min = 0L, long max = Long.MAX_VALUE)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/LongRange.html):
  For `Long` and `long` only.
- [`@BigRange(String min = "", String max = "")`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/BigRange.html):
  For `BigInteger` generation.
- [`@Positive`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/Positive.html):
  Numbers larger than `0`. For all integral types.
- [`@Negative`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/Negative.html):
  Numbers lower than `0`. For all integral types.


#### Decimal Constraints

- [`@FloatRange(float min = 0.0f, minIncluded = true, float max = Float.MAX_VALUE, maxIncluded = true)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/FloatRange.html):
  For `Float` and `float` only.
- [`@DoubleRange(double min = 0.0, minIncluded = true, double max = Double.MAX_VALUE, boolean maxIncluded = true)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/DoubleRange.html):
  For `Double` and `double` only.
- [`@BigRange(String min = "", minIncluded = true, String max = "", maxIncluded = true)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/BigRange.html):
  For `BigDecimal` generation.
- [`@Scale(int value)`](/docs/1.10.1/javadoc/net/jqwik/api/constraints/Scale.html):
...
Consider
[the following examples](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/VariableTypedPropertyExamples.java):
...
instead of using _jqwik_'s built-in ones. BTW, '@Example' is nothing but a plain annotation using [`@Property`](/docs/1.10.1/javadoc/net/jqwik/api/Property.html)
as "meta"-annotation.
...
Look at the
[following example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/ProvideMethodExamples.java):
...
The String value of the [`@ForAll`](/docs/1.10.1/javadoc/net/jqwik/api/ForAll.html)
...
[`@Arbitrary<? extends TParam>`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html)
...
The [`ArbitrarySupplier`](/docs/1.10.1/javadoc/net/jqwik/api/ArbitrarySupplier.html) 
...
[`Arbitraries`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html).

#### Generate values yourself

- [`Arbitrary<T> randomValue(Function<Random, T> generator)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#randomValue(java.util.function.Function)):
...
- [`Arbitrary<T> fromGenerator(RandomGenerator<T> generator)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#fromGenerator(net.jqwik.api.RandomGenerator)):
...
- [`Arbitrary<T> fromGeneratorWithSize(RandomGenerator<T> generator)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#fromGeneratorWithSize(java.util.function.IntFunction)):
  Allows to use the `genSize` parameter at creation time of a `RandomGenerator` instance.

#### Select or generate values randomly

- [`Arbitrary<U> of(U... values)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#of(U...)):
  Choose randomly from a list of values. Shrink towards the first one.

- [`Arbitrary<U> ofSuppliers(Supplier<U>... valueSuppliers)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#ofSuppliers(java.util.function.Supplier...)):
...
- [`Arbitrary<T> just(T constantValue)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#just(T)):
  Always provide the same constant value in each try. Mostly useful to combine with other arbitraries.

- [`Arbitrary<T> of(Class<T  extends Enum> enumClass)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#of(java.lang.Class)):
  Choose randomly from all values of an `enum`. Shrink towards first enum value.

- [`Arbitrary<T> create(Supplier<T> supplier)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#create(java.util.function.Supplier)):
...
[`Arbitraries.frequency(...)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#frequency(net.jqwik.api.Tuple.Tuple2...)):
...
[the given example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/ChoosingExamples.java#L17)
...
- [`CharacterArbitrary chars()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#chars())
- [`StringArbitrary strings()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#strings())
...
[`StringArbitrary.uniqueChars()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#uniqueChars()).
Here's an example:
...
- [`Arbitrary<Random> randoms()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#randoms()):
  Random instances will never be shrunk

#### Shuffling Permutations

- [`Arbitrary<List<T>> shuffle(T ... values)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#shuffle(T...)):
  Return unshrinkable permutations of the `values` handed in.

- [`Arbitrary<List<T>> shuffle(List<T> values)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#shuffle(java.util.List)):
  Return unshrinkable permutations of the `values` handed in.

#### Default Types

- [`Arbitrary<T> defaultFor(Class<T> type, Class<?> ... parameterTypes)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#defaultFor-java.lang.Class(java.lang.Class...)):
  ...
  cannot be used in the respective [`@ForAll`](/docs/1.10.1/javadoc/net/jqwik/api/ForAll.html) property method parameter. Raw types and wildcards,
...
- [`ByteArbitrary bytes()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#bytes())
- [`ShortArbitrary shorts()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#shorts())
- [`IntegerArbitrary integers()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#integers())
- [`LongArbitrary longs()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#longs())
- [`BigIntegerArbitrary bigIntegers()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#bigIntegers())

#### Decimals

- [`FloatArbitrary floats()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#floats())
- [`DoubleArbitrary doubles()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#doubles())
- [`BigDecimalArbitrary bigDecimals()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#bigDecimals())
...
[`withDistribution(distribution)`](https://jqwik.net/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/NumericalArbitrary.html#withDistribution(net.jqwik.api.RandomDistribution)).
Currently three different distributions are supported:

- [`RandomDistribution.biased()`](https://jqwik.net/docs/1.10.1/javadoc/net/jqwik/api/RandomDistribution.html#biased()):
  This is the default.
...
- [`RandomDistribution.uniform()`](https://jqwik.net/docs/1.10.1/javadoc/net/jqwik/api/RandomDistribution.html#uniform()):
  This distribution will generate values across the allowed range
  with a uniform probability distribution.

- [`RandomDistribution.gaussian(borderSigma)`](https://jqwik.net/docs/1.10.1/javadoc/net/jqwik/api/RandomDistribution.html#gaussian(double)):
...
- [`RandomDistribution.gaussian()`](https://jqwik.net/docs/1.10.1/javadoc/net/jqwik/api/RandomDistribution.html#gaussian()):
...
- [`ListArbitrary<T> Arbitrary.list()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#list())
- [`SetArbitrary<T> Arbitrary.set()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#set())
- [`StreamArbitrary<T> Arbitrary.streamOf()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#stream())
- [`IteratorArbitrary<T> Arbitrary.iterator()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#iterator())
- [`ArrayArbitrary<T, A> Arbitrary.array(Class<A> arrayClass)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#array(java.lang.Class))
...
[`Arbitrary.collect(Predicate condition)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#collect(java.util.function.Predicate))
...
Using [`Arbitrary.optional(double presenceProbability)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#optional(double))
allows to generate an optional of any type.
`Optional.empty()` values are injected with a probability of `1 - presenceProbability`.

Just using [`Arbitrary.optional()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#optional())
...
- [`Arbitrary.tuple1()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#tuple1())
- [`Arbitrary.tuple2()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#tuple2())
- [`Arbitrary.tuple3()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#tuple3())
- [`Arbitrary.tuple4()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#tuple4())
- [`Arbitrary.tuple5()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#tuple5())
...
[`Arbitraries.maps(...)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#maps-net.jqwik.api.Arbitrary(net.jqwik.api.Arbitrary)) like this:
...
[`Arbitraries.entries(...)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#maps(net.jqwik.api.Arbitrary,net.jqwik.api.Arbitrary)).
...
- [NumericalArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/BigDecimalArbitrary.html)
    - [BigDecimalArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/BigDecimalArbitrary.html)
    - [BigIntegerArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/BigIntegerArbitrary.html)
    - [ByteArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/ByteArbitrary.html)
    - [CharacterArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/CharacterArbitrary.html)
    - [DoubleArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/DoubleArbitrary.html)
    - [FloatArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/FloatArbitrary.html)
    - [IntegerArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/IntegerArbitrary.html)
    - [LongArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/LongArbitrary.html)
    - [ShortArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/ShortArbitrary.html)
- [SizableArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/SizableArbitrary.html)
    - [MapArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/MapArbitrary.html)
    - [StreamableArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/StreamableArbitrary.html)
        - [SetArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/SetArbitrary.html)
        - [ListArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/ListArbitrary.html)
        - [StreamArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/StreamArbitrary.html)
        - [IteratorArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/IteratorArbitrary.html)
        - [ArrayArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/ArrayArbitrary.html)
- [StringArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/StringArbitrary.html)
- [FunctionArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/FunctionArbitrary.html)
- [TypeArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/TypeArbitrary.html)
- [ActionSequenceArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/stateful/ActionSequenceArbitrary.html)


Here are a
[two examples](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/FluentConfigurationExamples.java)
...
call [`Arbitrary.injectNull(double probability)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#injectNull(double)).
...
use
[`Arbitrary.filter(Predicate<? super T> filterPredicate)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#filter(java.util.function.Predicate)).
...
[`Arbitrary.map(Function<T, U> mapper)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#map(java.util.function.Function)).
...
- [`ListArbitrary.mapEach`](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/ListArbitrary.html#mapEach(java.util.function.BiFunction))

- [`SetArbitrary.mapEach`](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/SetArbitrary.html#mapEach(java.util.function.BiFunction))
...
Have a look at the
[following example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L26):
...
- `begin` must not be larger than `end`
  ...
  [`flatMap`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#flatMap(java.util.function.Function))
  combined with a tuple type
  [like this](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L32):
...
- [`ListArbitrary.flatMapEach`](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/ListArbitrary.html#flatMapEach(java.util.function.BiFunction))

- [`SetArbitrary.flatMapEach`](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/SetArbitrary.html#flatMapEach(java.util.function.BiFunction))
...
[In this example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/OneOfExamples.java)
...
[`Arbitrary.ignoreExceptions(Class<? extends Throwable>...)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#ignoreExceptions(java.lang.Class...))
...
[`Arbitrary.fixGenSize(int)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#fixGenSize(int)).
...
[`Combinators.combine()`](/docs/1.10.1/javadoc/net/jqwik/api/Combinators.html#combine(net.jqwik.api.Arbitrary,net.jqwik.api.Arbitrary))
allows you to set up a composite arbitrary from up to eight parts.

[The following example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/MappingAndCombinatorExamples.java#L25)
...
Have a look at
[Builders.withBuilder(Supplier)](/docs/1.10.1/javadoc/net/jqwik/api/Builders.html#withBuilder(java.util.function.Supplier))
to check the API.
...
Look at the
[following example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/RecursiveExamples.java)
...
- It is important to use 
  [`lazyOf(suppliers)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#lazyOf(java.util.function.Supplier,java.util.function.Supplier...))
  instead of the seemingly simpler 
  [`oneOf(arbitraries)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#oneOf(net.jqwik.api.Arbitrary,net.jqwik.api.Arbitrary...)).
...
- [`Arbitraries.recursive(..., depth)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#recursive(java.util.function.Supplier,java.util.function.Function,int)).
- [`Arbitraries.recursive(..., minDepth, maxDepth)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#recursive(java.util.function.Supplier,java.util.function.Function,int,int)).
...
with [`Arbitrary.sample()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#sample()):
...
Getting a stream of generated values is just as easy with [`Arbitrary.sampleStream()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#sampleStream()):
...
[`Arbitrary.allValues()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#allValues()).
...
Use
[`Arbitrary.forEachValue(Consumer action)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#forEachValue(java.util.function.Consumer)).
...
Those tools are available in package [net.jqwik.api.state](/docs/1.10.1/javadoc/net/jqwik/api/state/package-summary.html).
...
[simple stack implementation](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/state/mystack/MyStringStack.java):
...
Jqwik's [new `Action` type](/docs/1.10.1/javadoc/net/jqwik/api/state/Action.html)
covers the idea that an action can be represented by "arbitrary" 
[transformers](/docs/1.10.1/javadoc/net/jqwik/api/state/Transformer.html);
...
- [`ActionChain`](/docs/1.10.1/javadoc/net/jqwik/api/state/ActionChain.html):
...
- [`ActionChain.startWith()`](/docs/1.10.1/javadoc/net/jqwik/api/state/ActionChain.html#startWith(java.util.function.Supplier)):
  This method will create an arbitrary for generating an `ActionChain`.
  This [`ActionChainArbitrary`](/docs/1.10.1/javadoc/net/jqwik/api/state/ActionChainArbitrary.html)
...
To make this abstract concept concrete, let's look at a
[simple stack implementation](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStack.java):
...
- [`Push`](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PushAction.java):
...
- [`Pop`](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PopAction.java):
  If (and only if) the stack is not empty, pop the element on top off the stack.
  The size of the stack should have decreased by 1.
...
- [`Clear`](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/ClearAction.java):
...
[_jqwik_ property](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStackProperties.java):
...
The interesting API elements are
- [`ActionSequence`](/docs/1.10.1/javadoc/net/jqwik/api/stateful/ActionSequence.html):
...
- [`Arbitraries.sequences()`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#sequences(net.jqwik.api.Arbitrary)):
...
[The following property](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/AssumptionExamples.java)
...
[`Assume.that(boolean condition)`](/docs/1.10.1/javadoc/net/jqwik/api/Assume.html#that(boolean))
...
[`@Property`](/docs/1.10.1/javadoc/net/jqwik/api/Property.html) annotation.
...
[`Assume.that()`](/docs/1.10.1/javadoc/net/jqwik/api/Assume.html#that(boolean))
...
[`Statistics.collect()`](/docs/1.10.1/javadoc/net/jqwik/api/statistics/Statistics.html#collect(java.lang.Object...))
...
[Here](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/statistics/StatisticsExamples.java)
...
There is a
[`@StatisticsReport`](/docs/1.10.1/javadoc/net/jqwik/api/statistics/StatisticsReport.html)
...
[StatisticsReportMode.OFF](/docs/1.10.1/javadoc/net/jqwik/api/statistics/StatisticsReport.StatisticsReportMode.html) and can have one of:
...
[`Histogram`](/docs/1.10.1/javadoc/net/jqwik/api/statistics/Histogram.html)
and [`NumberRangeHistogram`](/docs/1.10.1/javadoc/net/jqwik/api/statistics/NumberRangeHistogram.html).
...
[StatisticsReportFormat](/docs/1.10.1/javadoc/net/jqwik/api/statistics/StatisticsReportFormat.html) and
...
Start by looking at
[`Statistics.coverage()`](/docs/1.10.1/javadoc/net/jqwik/api/statistics/Statistics.html#coverage(java.util.function.Consumer))
...
- Implement the interface [`ArbitraryProvider`](/docs/1.10.1/javadoc/net/jqwik/api/providers/ArbitraryProvider.html).<br/>
...
with [`@ForAll`](/docs/1.10.1/javadoc/net/jqwik/api/ForAll.html) that has no explicit `value`.
...
Consider the class [`Money`](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/defaultprovider/Money.java):
...
[`MoneyArbitraryProvider`](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyArbitraryProvider.java):
...
in file
[`META-INF/services/net.jqwik.api.providers.ArbitraryProvider`](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/resources/META-INF/services/net.jqwik.api.providers.ArbitraryProvider)
with such an entry:
...
The
[following property](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyProperties.java)
...
1. Create an implementation of an interface, in this case
   [`ArbitraryConfigurator`](/docs/1.10.1/javadoc/net/jqwik/api/configurators/ArbitraryConfigurator.html).
...
the [`@Odd` annotation](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/Odd.java):
...
If you now
[register the implementation](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/resources/META-INF/services/net.jqwik.api.configurators.ArbitraryConfigurator),
the [following example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/OddProperties.java)
will work:
...
Deriving your implementation from [`ArbitraryConfiguratorBase`](/docs/1.10.1/javadoc/net/jqwik/api/configurators/ArbitraryConfiguratorBase.html) will largely simplify things:
...
[DomainContext](/docs/1.10.1/javadoc/net/jqwik/api/domains/DomainContext.html)
and [DomainContextBase](/docs/1.10.1/javadoc/net/jqwik/api/domains/DomainContextBase.html).
...
[in one place](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/domains/AmericanAddresses.java):
...
at the [complete example](https://github.com/jqwik-team/jqwik/blob/1.10.1/documentation/src/test/java/net/jqwik/docs/types/TypeArbitraryExamples.java)
and check the following api entry points:

- [UseType](/docs/1.10.1/javadoc/net/jqwik/api/constraints/UseType.html)
- [UseTypeMode](/docs/1.10.1/javadoc/net/jqwik/api/constraints/UseTypeMode.html)
- [Arbitraries.forType()](/docs/1.10.1/javadoc/net/jqwik/api/Arbitraries.html#forType(java.lang.Class))
- [TypeArbitrary](/docs/1.10.1/javadoc/net/jqwik/api/arbitraries/TypeArbitrary.html)
...
This is done through [`Arbitrary.edgeCases(config)`](/docs/1.10.1/javadoc/net/jqwik/api/Arbitrary.html#edgeCases(java.util.function.Consumer)). 
...
The [`Table` class](/docs/1.10.1/javadoc/net/jqwik/api/Table.html)
...
- call up the static method [`Web.emails()`](/docs/1.10.1/javadoc/net/jqwik/web/api/Web.html#emails()).
  The return type is [`EmailArbitrary`](/docs/1.10.1/javadoc/net/jqwik/web/api/EmailArbitrary.html)
  which provides a few configuration methods.

- or use the [`@Email`](/docs/1.10.1/javadoc/net/jqwik/web/api/Email.html)
...
- call up the static method [`Web.webDomains()`](/docs/1.10.1/javadoc/net/jqwik/web/api/Web.html#webDomains())

- or use the annotation [`@WebDomain`](/docs/1.10.1/javadoc/net/jqwik/web/api/WebDomain.html)
...
- [`@DateRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/DateRange.html)
- [`@YearRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/YearRange.html)
- [`@YearMonthRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/YearMonthRange.html)
- [`@MonthRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/MonthRange.html)
- [`@MonthDayRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/MonthDayRange.html)
- [`@DayOfMonthRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/DayOfMonthRange.html)
- [`@DayOfWeekRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/DayOfWeekRange.html)
- [`@PeriodRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/PeriodRange.html)
...
method call on class [`Dates`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html).
For example:
...
- [`LocalDateArbitrary dates()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#dates())
- [`CalendarArbitrary datesAsCalendar()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#datesAsCalendar())
- [`DateArbitrary datesAsDate()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#datesAsDate())
- [`YearArbitrary years()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#years())
- [`Arbitrary<Month> months()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#months())
- [`Arbitrary<Integer> daysOfMonth()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#daysOfMonth())
- [`Arbitrary<DayOfWeek> daysOfWeek()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#daysOfWeek())
- [`YearMonthArbitrary yearMonths()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#yearMonths())
- [`MonthDayArbitrary monthDays()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#monthDays())
- [`PeriodArbitrary periods()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Dates.html#periods())
...
- [`@TimeRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/TimeRange.html)
- [`@OffsetRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/OffsetRange.html)
- [`@HourRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/HourRange.html)
- [`@MinuteRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/MinuteRange.html)
- [`@SecondRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/SecondRange.html)
- [`@Precision`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/Precision.html)
- [`@DurationRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/DurationRange.html)
...
method call on class [`Times`](/docs/1.10.1/javadoc/net/jqwik/time/api/Times.html).
For example:
...
- [`LocalTimeArbitrary times()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Times.html#times())
- [`OffsetTimeArbitrary offsetTimes()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Times.html#offsetTimes())
- [`ZoneOffsetArbitrary zoneOffsets()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Times.html#zoneOffsets())
- [`Arbitrary<TimeZone> timeZones()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Times.html#timeZones())
- [`Arbitrary<ZoneId> zoneIds()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Times.html#zoneIds())
- [`DurationArbitrary durations()`](/docs/1.10.1/javadoc/net/jqwik/time/api/Times.html#durations())
...
- [`@DateTimeRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/DateTimeRange.html)
- [`@InstantRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/InstantRange.html)
- [`@DateRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/DateRange.html)
- [`@YearRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/YearRange.html)
- [`@MonthRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/MonthRange.html)
- [`@DayOfMonthRange`](/docs/1.10.1/javadoc/net/jqwik/time/api/constraints/DayOfMonthRange.html)
...
method call on class [`DateTimes`](/docs/1.10.1/javadoc/net/jqwik/time/api/DateTimes.html).
For example:
...
- [`LocalDateTimeArbitrary dateTimes()`](/docs/1.10.1/javadoc/net/jqwik/time/api/DateTimes.html#dateTimes())
- [`InstantArbitrary instants()`](/docs/1.10.1/javadoc/net/jqwik/time/api/DateTimes.html#instants())
- [`OffsetDateTimeArbitrary offsetDateTimes()`](/docs/1.10.1/javadoc/net/jqwik/time/api/DateTimes.html#offsetDateTimes())
- [`ZonedDateTimeArbitrary zonedDateTimes()`](/docs/1.10.1/javadoc/net/jqwik/time/api/DateTimes.html#zonedDateTimes())
...
1. There are several [types of lifecycle hooks](#lifecycle-hook-types),
   ...
   [`net.jqwik.api.lifecycle.LifecycleHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/LifecycleHook.html).
...
3. You can add a concrete lifecycle hook to a container class or a property method with the annotation
   [`@AddLifecycleHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/AddLifecycleHook.html).
...
7. If relevant, the order in which hook methods are being applied is determined by dedicated methods
   ...
   [`BeforeContainerHook.beforeContainerProximity()`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/BeforeContainerHook.html#beforeContainerProximity()).
...
- [`propagateTo()`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/LifecycleHook.html#propagateTo()):
  Determine if and how a hook will be propagated to an element's children.

- [`appliesTo(Optional<AnnotatedElement>)`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/LifecycleHook.html#appliesTo(java.util.Optional)):
...
Implement [`SkipExecutionHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/SkipExecutionHook.html)
...
Implement [`BeforeContainerHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/BeforeContainerHook.html)
...
Implement [`AfterContainerHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/AfterContainerHook.html)
...
[`AroundContainerHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/AroundContainerHook.html)
...
[`AroundPropertyHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/AroundPropertyHook.html)
...
and publish the result using a [`Reporter`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/Reporter.html):
...
[`AroundTryHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/AroundTryHook.html).
...
[`ResolveParameterHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/ResolveParameterHook.html).
...
Use [`RegistrarHook`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/RegistrarHook.html)
...
[`net.jqwik.api.lifecycle.Store`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/Store.html).
...
- has a [`Lifespan`](/docs/1.10.1/javadoc/net/jqwik/api/lifecycle/Lifespan.html).
...
its [Javadoc](/docs/1.10.1/javadoc) but also through reflection.
...
Read this version's [release notes](/release-notes.html#1101).
