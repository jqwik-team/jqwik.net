...
[Here](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/PropertyBasedTests.java)
...
[Here](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/ExampleBasedTests.java)
...
Have a look at [this example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/TestsWithGroups.java):
...
[In the following example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/NamingExamples.java),
...
Have a look at 
[the following example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/TaggingExamples.java).
...
Consider
[the following examples](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/VariableTypedPropertyExamples.java):
...
Look at the 
[following example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/ProvideMethodExamples.java):
...
[the given example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/ChoosingExamples.java#L17)
...
Here are a 
[two examples](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/FluentConfigurationExamples.java)
...
Have a look at the 
[following example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L26):
...
[like this](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/FlatMappingExamples.java#L32):
...
[In this example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/OneOfExamples.java)
...
[The following example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/MappingAndCombinatorExamples.java#L25)
...
Look at the 
[following example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/RecursiveExamples.java)
...
[simple stack implementation](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStack.java):
...
- [`Push`](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PushAction.java):
...
- [`Pop`](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/stateful/mystack/PopAction.java):
...
- [`Clear`](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/stateful/mystack/ClearAction.java):
...
[_jqwik_ property](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/stateful/mystack/MyStringStackProperties.java):
...
[The following property](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/AssumptionExamples.java)
...
[Here](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/statistics/StatisticsExamples.java)
...
Consider the class [`Money`](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/defaultprovider/Money.java):
...
[`MoneyArbitraryProvider`](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyArbitraryProvider.java):
...
in file 
[`META-INF/services/net.jqwik.api.providers.ArbitraryProvider`](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/resources/META-INF/services/net.jqwik.api.providers.ArbitraryProvider)
with such an entry:
...
The 
[following property](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/defaultprovider/MoneyProperties.java)
...
the [`@Odd` annotation](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/Odd.java)
together with the 
[configurator implementation](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/OddConfigurator.java):
...
If you now 
[register the implementation](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/resources/META-INF/services/net.jqwik.api.configurators.ArbitraryConfigurator),
the [following example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/arbitraryconfigurator/OddProperties.java)
will work:
...
[AmericanAddresses](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/domains/AmericanAddresses.java).
Now look at
[this example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/domains/AddressProperties.java):
...
at the [complete example](https://github.com/jlink/jqwik/blob/1.3.5/documentation/src/test/java/net/jqwik/docs/types/TypeArbitraryExamples.java)
